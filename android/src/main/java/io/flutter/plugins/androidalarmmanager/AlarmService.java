...
public class AlarmService extends Service {
  ...
  public static void enqueueAlarmProcessing(Context context, Intent alarmIntent) {
    Intent serviceIntent = new Intent(context, AlarmService.class);
    serviceIntent.putExtras(alarmIntent);
...
public static void cancel(Context context, int requestCode) {
  ...
  public int onStartCommand(Intent intent, int flags, int startId) {
    ...
    // Process the work in background
    executor.execute(() -> handleWork(intent));
   ...
   * {@code intent} is added to the {@link #alarmQueue} to be invoked later, after all pre-existing
   * callbacks have been executed.
   */
private void handleWork(final Intent intent) {
